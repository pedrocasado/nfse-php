...
final class NFSeResponseDTOTest extends TestCase
{
    ...
    public function testFromXmlParsesNNfseAndMainFields(): void
    {
    ...
    public function testFromXmlParsesEmitAndValores(): void
    {
        $dto = NFSeResponseDTO::fromXml(self::SAMPLE_XML);
    ...
    public function testFromXmlThrowsOnInvalidXml(): void
    {
    ...
    public function testFromXmlThrowsOnMissingInfNfse(): void
    {
        $this->expectException(\InvalidArgumentException::class);
